...
- RStudio dispose d'un outil graphique pour importer des données :
.center[
![:scale 70%](img/RStudio_data_import2.png)
]
---
...
## dplyr: arrange()
.center[
![:scale 40%](img/dplyr_arrange.png)
]
...
- #### `summarise()` permet de **résumer plusieurs valeurs en une seule**, en particulier à partir d'un tableau agrégé par `group_by()` 
...
.center[
![:scale 40%](img/dplyr_summarise.png)
]
...
.pull-left[
.center[
![](img/dplyr_cheatsheet_1.png)
]
]

.pull-right[
.center[
![](img/dplyr_cheatsheet_2.png)
]
]
.center[
